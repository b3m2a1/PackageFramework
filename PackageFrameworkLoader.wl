...
(* ::Text:: *)
(*Stuff specific to the operation of the package and not related to LoadPackage or any of the other functionality*)
...
PackageAutoloadPackage::usage="Loads a package via PackageExecute";
PackageLoadDeclare::usage="Declares a package";


PackageFrameworkPackageLoad::usage="Calls LoadDeclare on a package";
...
PackageFrameworkConfig[ops_, paclet_, rootDirectory_]:=
  Module[
    ...
    Join[
       ...
       Replace[{
         r:{(_?OptionQ|_Association)..}:>Merge[r, First],
         {e_, ___}:>e
         }]
       ]&
    ]
...
PackageAddContexts[pkg_, conts_]:=
  SetProperty[pkg, "Contexts"->DeleteDuplicates@Flatten@{PackageContexts[pkg], conts}]

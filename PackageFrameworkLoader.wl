...
(* ::Text::GrayLevel[0.5]:: *)
(* Autogenerated PackageFramework loader file *)


Temp`PackageScope`PackageFrameworkLoading`Private`$DependencyLoad=
  TrueQ@Temp`PackageScope`PackageFrameworkLoading`Private`$DependencyLoad;
If[Temp`PackageScope`PackageFrameworkLoading`Private`$DependencyLoad,
  Unprotect["`PackageFramework`PackageScope`Private`Constants`$TopLevelLoad"];
  Evaluate[Symbol["`PackageFramework`PackageScope`Private`Constants`$TopLevelLoad"]]=False,
  Unprotect["PackageFramework`PackageScope`Private`Constants`$TopLevelLoad"];
  Evaluate[Symbol["PackageFramework`PackageScope`Private`Constants`$TopLevelLoad"]]=
    MemberQ[$ContextPath, "Global`"]
  ];


If[Temp`PackageScope`PackageFrameworkLoading`Private`$DependencyLoad,
  Evaluate[Symbol["`PackageFramework`PackageScope`Private`$RootContext"]]=$Context;
  BeginPackage["`PackageFramework`"],
  Evaluate[Symbol["PackageFramework`PackageScope`Private`$RootContext"]]="";
  BeginPackage["PackageFramework`"]
  ]


ClearAll[PackageFramework];
PackageFramework::usage="PackageFramework is a manager head for the PackageFramework package";
...
PackageFramework["Directory"]:=
  $PackageDirectory;
$PackageDirectory=
  DirectoryName@$InputFileName;


PackageFramework["Name"]:=
  $PackageName;
$PackageName=
  "PackageFramework";
...
PackageFramework["LoadingParameters"]:=$PackageLoadSpecs
$PackageLoadSpecs=
  Merge[
    {
      With[
...
PackageFramework["Mode"]:=$PackageLoadingMode
$PackageLoadingMode=
...
PackageFramework["Dependencies"]:=$PackageDependencies;
$PackageDependencies=
...
PackageFramework["DependencyBase"]:=$PackageDependencyBase;
...
PackageFramework["PackageListing"]:=$PackageListing;
$PackageListing=<||>;
PackageFramework["Contexts"]:=$PackageContexts;
  ...
  $PackageContexts=
    Join[
      If[$PackageLoadingMode==="Dependency",
        ...
        {
          "PackageFramework`",
          "PackageFramework`PackageScope`Private`",
          "PackageFramework`PackageScope`Package`"
          },
...
PackageFramework["FEScopedSymbols"]:=$PackageFEHiddenSymbols;
$PackageFEHiddenSymbols={};
PackageFramework["PackageScopedSymbols"]:=$PackageScopedSymbols;
...
PackageFramework["FileContexts"]:=$PackageFileContexts;
...
PackageFramework["DeclaredPackages"]:=$DeclaredPackages;
...
PackageFramework["LoadedPackages"]:=$LoadedPackages;
...
PackageFileContext[f_String?DirectoryQ]:=
  With[{s=PackageFileContextPath[f]},
    StringRiffle[Append[""]@Prepend[s,PackageFramework],"`"]
    ];
  ...
  With[{
    newcont=
      If[StringStartsQ[context, "`"],
        "PackageFramework"<>context<>scope<>"`",
        context<>scope<>"`"
        ],
...
PackageFramework::nodep="Couldn't load dependency `` of type ``";
PackageFramework::nodup="Couldn't update dependency `` of type ``";
  ...
  Block[{retcode, site, path, file, tmp},
    ...
    site=
      ...
      If[retcode<300,
        ...
        DeleteFile[tmp];
        file,
        Message[PackageFramework::nodep, dep, "Package"];
        DeleteFile[tmp];
        $Failed
        ]
      ];
    ...
    Monitor[
      MapThread[
        Check[
          ...
          Message[PackageFramework::nodep, #2, "Paclet"];
          $Failed
          ]&,
        {
          pacs,
      ...
      Monitor[
        MapThread[
          Check[
            ...
            Message[PackageFramework::nodup, #2, "Paclet"];
            $Failed
            ]&,
          {
            StringDelete[deps, "`"],
...
$PackageErrorMessage=
  "PackageFramework encountered exception ``";
...
PackageThrowMessage[
  ...
  PackageThrowMessage[
    MessageName[PackageFramework, tag],
    body,
    ops
    ];
PackageThrowMessage[
...
PackageCatchMessage[
  ...
  Replace[
    Thread[Map[Hold[MessageName[PackageFramework, #]]&, msg], Hold],
    {
      {}:>
        Check[expr, 
...
PackageFailureException[
  ...
  (
    Set[MessageName[PackageFramework, tag], body];
    PackageFailureException[
      MessageName[PackageFramework, tag],
      body,
      ops
...
PackageAttachMainAutocomplete[]:=
  PackageAddAutocompletions[PackageFramework, 
    Table[
      Replace[{}->None]@
        Cases[
          DownValues[PackageFramework],
          Nest[
            Insert[#, _, {1, 1, 1}]&,
            (HoldPattern[Verbatim[HoldPattern]][
              PackageFramework[s_String, ___]
              ]:>_),
            n-1
            ]:>s,
          Infinity
...
PackagePrepPackageSymbol[]:=
  Switch[$AllowPackageSymbolDefinitions,
    None,
      If[Length@OwnValues[PackageFramework]==0,
        Remove[PackageFramework],
        DownValues[PackageFramework]={}
        ],
    False,
      If[Length@OwnValues[PackageFramework]==0,
        Clear[PackageFramework],
        DownValues[PackageFramework]={}
        ],
    _,
      PackageAttachMainAutocomplete[]
...
If[Temp`PackageScope`PackageFrameworkLoading`Private`$DependencyLoad,
  If[
    (Clear@`PackageFramework`PackageScope`Private`$loadAbort;!#)&@
      `PackageFramework`PackageScope`Private`$loadAbort,
    Unprotect[`PackageFramework`PackageScope`Private`$LoadCompleted];
    `PackageFramework`PackageScope`Private`$LoadCompleted=True;
    `PackageFramework`PackageScope`Private`PackagePostProcessContextPathReassign[]
    ],
  If[
    (Clear@PackageFramework`PackageScope`Private`$loadAbort;!#)&@
      PackageFramework`PackageScope`Private`$loadAbort,
...
Remove["Temp`PackageScope`PackageFrameworkLoading`Private`*"]